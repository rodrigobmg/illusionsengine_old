#ifndef ILL_SYSTEM_OGREGRAPHICS_OGRERENDERER
#define ILL_SYSTEM_OGREGRAPHICS_OGRERENDERER

// This function will be exported to load our Ogre graphics renderer.
extern Ill::System::Graphics::GraphicsRenderer* gs_GraphicsRenderer;
...
namespace Ill
{
    namespace System
    {
        ...
        {
            class _IllExport OgreRenderer : public Ill::System::Graphics::GraphicsRenderer
            {
            public:
